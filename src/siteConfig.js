...
const sites = {
  pike: {
    ...
    logoAlt: 'Charga On The Pike logo',
    favicon: '/favicon.svg',
    ...
    heroEyebrow: 'Kabobs, Bowls & Sandwiches',
    heroTitle: 'All Flavor. No Frills.',
    heroImage: '/images/hero.jpg',
    heroImageAlt:
      'Sizzling halal kabobs and Pakistani street food at Charga On The Pike in Arlington, VA',
  ...
  grill: {
    ...
    heroTitle: 'All Flavor. No Frills.',
    heroImage: '/images/hero.jpg',
    heroImageAlt: 'Halal grill chicken and kabobs at Charga Grill on Langston Boulevard in Arlington, VA',
